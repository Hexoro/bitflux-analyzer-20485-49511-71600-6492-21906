/**
 * Algorithm Panel V2 - Redesigned with new tab structure
 * Tabs: Player, Results, Files, Strategy, Metrics, Operations
 */
...
type AlgorithmTab = 'player' | 'results' | 'files' | 'strategy' | 'metrics' | 'operations';
...
export const AlgorithmPanel = () => {
  ...
  const handleResultSelect = (result: ExecutionResultV2 | null) => {
    ...
    <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as AlgorithmTab)} className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-hidden">
        <TabsContent value="player" className="h-full m-0">
          <PlayerTab result={currentResult} />
        </TabsContent>
